  ...
  return (
    <div className="w-full space-y-3 select-none">
      ...
      <div className="grid grid-cols-3 gap-2 text-center" role="region" aria-label="Workout Progress">
        <div className="bg-zinc-900/60 border border-zinc-800/90 rounded-xl py-2 px-1">
          <div className="text-[11px] font-bold text-zinc-400 uppercase tracking-wider">
            Set
          </div>
          <div
            className="text-base sm:text-lg font-black text-white font-mono mt-0.5"
            aria-label={`Set ${currentSet} of ${totalSets}`}
          >
            {currentSet} <span className="text-zinc-500 font-medium">/</span> {totalSets}
          </div>
        </div>
        ...
        <div className="bg-zinc-900/60 border border-zinc-800/90 rounded-xl py-2 px-1">
          ...
          >
            {currentRound} <span className="text-zinc-500 font-medium">/</span> {totalRounds}
          </div>
        </div>
        ...
        <div className="bg-zinc-900/60 border border-zinc-800/90 rounded-xl py-2 px-1">
          ...
          >
            {currentStep} <span className="text-zinc-500 font-medium">/</span> {totalSteps}
          </div>
        </div>
      </div>
