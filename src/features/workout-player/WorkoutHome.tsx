...
export function WorkoutHome({
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100 flex flex-col justify-between max-w-4xl mx-auto p-4 sm:p-6 select-none">
      {/* App Top Bar */}
      <header className="pt-2 pb-6 border-b border-zinc-800/80 flex flex-col sm:flex-row items-center justify-between gap-4">
        <div className="flex items-center gap-3 text-center sm:text-left">
          <div className="w-10 h-10 rounded-2xl bg-emerald-500/10 border border-emerald-500/30 flex items-center justify-center text-emerald-400 font-black text-xl shadow-lg shadow-emerald-950/20">
            CTR
          </div>
          <div>
            <h1
              aria-label="CTR Custom Training Timer"
              className="text-xl sm:text-2xl font-black tracking-tight text-white flex items-center gap-2"
            >
              CTR
            </h1>
        ...
        <div className="flex items-center gap-3">
          <div className="hidden sm:inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-zinc-900 border border-zinc-800 text-[11px] font-bold text-emerald-400 uppercase tracking-wider">
      ...
      <main className="flex-1 space-y-8 my-6">
        ...
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-emerald-950/50 via-zinc-900 to-zinc-900/90 border border-emerald-500/30 p-6 sm:p-8 shadow-2xl shadow-emerald-950/20 flex flex-col sm:flex-row items-center justify-between gap-6">
          <div className="space-y-2 text-center sm:text-left">
            <div className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full bg-emerald-500/10 text-emerald-400 border border-emerald-500/30 text-[10px] font-black uppercase tracking-wider">
        ...
        <section aria-label="My custom workouts" className="space-y-4">
          ...
          {isLoadingSaved ? (
            ...
            /* Empty State */
            <div className="bg-zinc-900/40 border border-dashed border-zinc-800/90 rounded-3xl p-8 text-center space-y-3.5">
              ...
              <div className="space-y-1">
                <h3 className="text-sm font-bold text-zinc-200">No custom workouts yet</h3>
              ...
              <button
                type="button"
                onClick={onCreateWorkout}
                className="mt-2 px-5 py-2.5 rounded-xl bg-zinc-800 hover:bg-zinc-700 text-white font-bold text-xs uppercase tracking-wider inline-flex items-center gap-2 transition-colors cursor-pointer"
              >
              ...
              {savedWorkouts.map((saved) => {
                ...
                return (
                  <article
                    ...
                    className="bg-zinc-900/80 border border-zinc-800/80 hover:border-zinc-700/80 rounded-2xl p-5 shadow-lg shadow-black/20 flex flex-col justify-between gap-4 transition-all"
                  >
                    <div className="space-y-2">
                      <div className="flex items-start justify-between gap-2">
                        ...
                        <span className="text-[10px] font-black uppercase tracking-wider px-2 py-0.5 rounded-md bg-emerald-500/10 text-emerald-400 border border-emerald-500/30 shrink-0">
                          Custom
                        </span>
                      </div>
                      ...
                      <div className="flex flex-wrap items-center gap-x-3 gap-y-1.5 pt-2 text-[11px] font-semibold text-zinc-400">
                    ...
                    <div className="pt-3 border-t border-zinc-800/80 flex items-center justify-between gap-2">
                      <div className="flex items-center gap-1">
                        ...
                        <button
                          ...
                          className="p-2 rounded-xl text-zinc-400 hover:text-emerald-400 hover:bg-zinc-800 transition-colors cursor-pointer"
            ...
            {workouts.map((preset) => {
              ...
              return (
                <article
                  ...
                  className="bg-zinc-900/60 border border-zinc-800/80 hover:border-zinc-700/80 rounded-2xl p-5 shadow-lg shadow-black/20 flex flex-col justify-between gap-4 transition-all"
                >
                  <div className="space-y-2.5">
                    ...
                    <div className="flex flex-wrap items-center gap-x-3 gap-y-1.5 pt-1 text-[11px] font-semibold text-zinc-400">
                  ...
                  <div className="pt-3 border-t border-zinc-800/80 flex items-center justify-between gap-2">
                    {onCustomizePreset ? (
                      <button
                        ...
                        className="px-3 py-2 rounded-xl bg-zinc-900 border border-zinc-800 hover:border-zinc-700 text-zinc-300 hover:text-white font-bold text-xs uppercase tracking-wider flex items-center gap-1.5 transition-colors cursor-pointer"
                      >
