...
export function WorkoutComplete({
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100 flex flex-col justify-between max-w-xl mx-auto p-4 sm:p-6 select-none animate-in fade-in zoom-in-95 duration-200">
      {/* Header */}
      <header className="pt-6 pb-2 text-center space-y-4">
        <div className="w-20 h-20 rounded-3xl bg-emerald-500/10 border border-emerald-500/30 text-emerald-400 mx-auto flex items-center justify-center shadow-xl shadow-emerald-950/30">
      ...
      <main className="flex-1 flex flex-col justify-center my-4 space-y-3">
        <div className="bg-zinc-900/60 border border-zinc-800 rounded-3xl p-5 space-y-4">
          <h2 className="text-xs font-bold uppercase tracking-widest text-zinc-400 text-center">
            Workout Summary
          </h2>
      ...
      <footer className="pt-2 pb-2 space-y-3">
        <button
          ...
          className="w-full bg-zinc-900 hover:bg-zinc-800 active:bg-zinc-700 text-zinc-100 border border-zinc-700/80 font-bold text-base sm:text-lg py-4 px-6 rounded-2xl shadow-lg transition-all duration-150 active:scale-[0.98] flex items-center justify-center gap-2.5 cursor-pointer"
        >
        ...
        <button
          ...
          className="w-full bg-emerald-500 hover:bg-emerald-400 active:bg-emerald-600 text-zinc-950 font-black text-base sm:text-lg py-4 px-6 rounded-2xl shadow-xl shadow-emerald-950/40 transition-all duration-150 active:scale-[0.98] flex items-center justify-center gap-2.5 cursor-pointer"
        >
